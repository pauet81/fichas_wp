...
<main class="blog-index">
    <section class="blog-hero">
        <div class="blog-hero-inner">
            ...
            <?php else : ?>
                <p>ArtÃ­culos agrupados en esta categorÃ­a.</p>
            <?php endif; ?>
        </div>
    </section>
    ...
    <section class="blog-wrapper">
        ...
        <?php if ( ! empty( $blog_categories ) ) : ?>
            <div class="blog-categories">
                <?php foreach ( $blog_categories as $cat ) : ?>
                    <a class="blog-cat-card<?php echo is_category( $cat->term_id ) ? ' is-active' : ''; ?>" href="<?php echo esc_url( get_category_link( $cat->term_id ) ); ?>">
                        ...
                        <a class="blog-card-link" href="<?php the_permalink(); ?>">
                            ...
                            <div class="blog-card-body">
                                <div class="blog-card-meta">
                                    ...
                                    <span class="blog-card-sep">Â·</span>
        ...
        <?php else : ?>
            <p class="blog-empty">AÃºn no hay artÃ­culos publicados en esta categorÃ­a.</p>
        <?php endif; ?>
    </section>
</main>

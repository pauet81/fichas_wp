...
class Breadcrumb_Trail
{
	...
	public function __construct($args       = array())
	{
		...
		$asap_schema_breadcrumbs = get_option('asap_schema_breadcrumbs', true);
	...
	protected function add_singular_items()
	{
		...
		if ( $post_title && ! get_theme_mod('asap_hide_breadcrumb_title') ) {
...
function breadcrumb_trail_shortcode($atts) {
    $args = shortcode_atts(array(
        ...
        'echo' => false,
        'show_schema' => '',
        'customizer_schema' => get_option('asap_schema_breadcrumbs', true),
    ), $atts);

    return breadcrumb_trail($args);
}
add_shortcode('asap_breadcrumb', 'breadcrumb_trail_shortcode');

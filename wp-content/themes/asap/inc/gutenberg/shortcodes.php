...
wp_register_script( 'clusters-js', get_template_directory_uri() . '/inc/gutenberg/assets/js/shortcodes.min.js', array( 'jquery'), '902220923', true );
...
//add_menu_page('Shortcodes', 'Shortcodes', 'manage_options', 'shortcodes', 'asap_add_shortcodes_options', asap_icon_svg());
//}

add_action("admin_menu", "asap_add_options");
function asap_add_options() {
    add_submenu_page(
        'asap-menu',               // Slug del menú principal
        'Shortcodes',              // Título de la página
        'Shortcodes',              // Título del menú
        'manage_options',          // Capacidad requerida
        'shortcodes',              // Slug de la subpágina
        'asap_add_shortcodes_options' // Función que muestra la página
    );
}
...
<div class="wrap wrapper-asap-options">
                ...
                <div class="nav-tab-wrapper">
                    ...
                    <div style="text-align:center; ">
                        ...
                        <a href="?page=shortcodes" class="nav-tab nav-tab-active">
                           <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-code" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.25" stroke="#464646" fill="none" stroke-linecap="round" stroke-linejoin="round">
                             <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                             <path d="M7 8l-4 4l4 4" />
                             <path d="M17 8l4 4l-4 4" />
                             <path d="M14 4l-4 16" />
                           </svg>
                            <span><?php _e('Shortcodes', 'asap'); ?></span>
                        </a>   
                      ...
                      <div class="gute-add-cluster3-categories gute-cluster-type">
                        ...
                        <div class="list_options"> 
                              ...
                              <div class="list_options"> 
                                 ...
                                 <select name="asap_cluster3_orderby" id="asap_cluster3_orderby" style="margin: 2px 0px 10px;">
                              ...
                              <div class="list_options"> <span class="label"><?php _e('Columns', 'asap'); ?></span>
                                 <select name="asap_cluster3_cols" id="asap_cluster3_cols" style="margin: 2px 0px 10px;">

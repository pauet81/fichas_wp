						...
						<td colspan="3" style="padding-top:20px;">
							...
							<table class="form-table custom-params" style="max-width:none; border:none;">
								...
								<tbody>
														...
														<fieldset>
															<table cellpadding="0" cellspacing="5" class="cf-form-table" rel="serialized_<?php echo $i; ?>">
																...
																<tbody>
																	...
																	<tr>
																		<td colspan="3">
																			<a href="javascript:void(0);" title="<?php _e('Add Meta', 'wp-all-import-pro')?>" class="action add-new-key add-new-entry"><?php _e('Add Another', 'wp-all-import-pro') ?></a>
																		</td>
																	</tr>
																	<tr>
																		<td>
									...
									<tr>
										<td colspan="2"><a href="javascript:void(0);" title="<?php printf(__('Add %s Meta', 'wp-all-import-pro'), $custom_type->labels->singular_name); ?>" class="action add-new-custom add-new-entry"><?php printf(__('Add %s Meta', 'wp-all-import-pro'), $custom_type->labels->singular_name); ?></a></td>
									</tr>
								</tbody>
							</table>

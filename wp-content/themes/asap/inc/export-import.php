...
final class asap_Export_Import_Core
{
    ...
    private static function _import($wp_customize)
    {
        ...
        // ✅ Use file_get_contents() instead of wp_remote_get() to support protected environments (Docker, VPS with basic auth)
        $raw = file_get_contents($file['file']);
        
        if ($raw === false) {
            $asap_Export_Import_error = __('An error occurred reading the configuration file. Please try again.', 'asap');
            return;
        }

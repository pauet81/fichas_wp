...
<div class="wpallimport-collapsed wpallimport-section">
	...
	<div class="wpallimport-content-section">
		<div class="wpallimport-collapsed-header">
			<h3><?php printf(__('How do you want to import your %s?', 'wp-all-import-pro'), $cpt_name); ?></h3>
		</div>
						...
						<td>
							...
							<div>
								<label>
									...
									<h4 style="margin: 0; display: inline-block; font-size: 14px;"><?php printf(__('Create new %s for each record in this import file', 'wp-all-import-pro'), $cpt_name); ?></h4>
								</label>
							</div>
							<div class="wpallimport-wizard-description">
								<?php printf(__('First run creates new %s. Re-running this import will update those same %s using the Unique Identifier.', 'wp-all-import-pro'), $cpt_name, $cpt_name); ?>
							</div>
							...
							<div class="wpallimport-wizard-section-spacing">
								<label>
									...
									<h4 style="margin: 0; display: inline-block; font-size: 14px;"><?php printf(__('Attempt to match to existing %s before creating new ones', 'wp-all-import-pro'), $cpt_name); ?></h4>
								</label>
							</div>
							<div class="wpallimport-wizard-description">
								<?php printf(__('Records in this import file will be matched with %s on your site based on...', 'wp-all-import-pro'), $cpt_name); ?>
							</div>

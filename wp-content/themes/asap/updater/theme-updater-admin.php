...
class EDD_Theme_Updater_Admin {
	...
	public function license_menu() {
		...
		add_submenu_page(
		    'asap-menu',               // Slug del menú principal de tu theme
		    $strings['theme-license'],  // Título de la página
		    'Licencia',  // Texto que aparece en el menú
		    'manage_options',           // Capacidad requerida para acceder a esta página
		    $this->theme_slug . '-license', // Slug único para la página
		    array( $this, 'license_page' )  // Callback para mostrar el contenido de la página
		);
	}
	...
	function show_activate_msg() {
		...
		if( ! $license && $page != 'asap-license' ) { ?>
			...
			<div class="update-nag notice-warning notice">
				...
				<p><a href="<?php echo admin_url('admin.php?page=' . $this->theme_slug .'-license'); ?>"><?php  _e( 'Complete the installation now', 'asap' ); ?></a></p>
			</div>	
